...
A fortune teller app created with flutter and firebase. Also this app includes a web site created with firebase hosting. If you wanna download admin app (for manage fortunes like add fortune, delete fortune etc. ) check this -> [Falcı Gacı Admin](https://github.com/Turkmen48/falci-gaci-admin)
