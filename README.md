...
A fortune teller app created with flutter and firebase. If you wanna download admin app (this app for manage fortunes like add fortune, delete fortune etc. ) check this -> Falcı Gacı Admin
